...
module.exports = {
  ...
  // The five cultural collections, plus products — they join the /enjoying/
  // stream even though their own pages belong to the products group.
  inputs: ['reading', 'music', 'movies', 'podcasts', 'bookshelf', 'products'],
